        ...
        if (bOutFBX)
        {
            ...
            if (bOutMesh)
            {
                ...
                if (bOutComponent)
                {
                    ...
                    sw_component_bin = File.Open(strFilename + ".component.bin", FileMode.Create);
                    FileInfo fi;
    ...
    void OnApplicationQuit() {
		if (bFirst) {
			...
			if (!bSave && bOutFBX) {
                ...
                string[] strVersions = { "", "FBX201100", "FBX201200", "FBX201300", "FBX201400", "FBX201600", "FBX201700" };
				...
				if (bOutComponent)
				{
                    ...
                    {
                        sw_component.Close();
                        FileInfo fi = new FileInfo(strFilename + ".component.txt");
                        sw_component_all = fi.CreateText();
                        sw_component_all.WriteLine("ComponentCount," + iSW_ComponentCount);
                        FileInfo fi2 = new FileInfo(strFilename + ".component_data.txt");
